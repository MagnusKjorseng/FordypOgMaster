...
#include "interfaces/msg/detail/thruster_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::ThrusterCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::ThrusterCommand & ros_message)
{
  // Member: rpm
  cdr >> ros_message.rpm;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::ThrusterCommand;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
max_serialized_size_key_ThrusterCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const interfaces::msg::ThrusterCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::ThrusterCommand *>(
    untyped_ros_message);
...
static size_t _ThrusterCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ThrusterCommand(full_bounded, is_plain, 0);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_ThrusterCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, ThrusterCommand)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_ThrusterCommand__handle;
}
