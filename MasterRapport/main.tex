...
\pagestyle{plain}
\fancyhead[L]{Master's thesis \\ IP502022}
%\fancyhead[C]{Candidate 10016}
\fancyhead[R]{Magnus Renaa Kjørseng}
% \fancyhead[R]{\today}
...
\noindent \textbf{\Large Development, Implementation, and Testing of a Reversible Master/Slave Control System for a Non-Buoyant ROV and USV} \\
\vspace{0.5cm}
...
\vspace{7cm}
\noindent Master's thesis, IP502022 \\
...
\import{Chapters/}{00Abstract} %insert the chapter text from the files

%\chapter*{Preface}
%\addcontentsline{toc}{chapter}{\protect\numberline{}Preface} 
%\import{Chapters/}{01Preface}
...
% \import{Chapters/}{02Abbreviations}
%\newpage
%\myemptypage
...
\import{Chapters/}{03Introduction}
\cleardoublepage
...
\import{Chapters/}{04Theory}
\cleardoublepage

\chapter{Design}
\import{Chapters/}{05Method}
\cleardoublepage

\chapter{Results}
\import{Chapters/}{06Results}
\cleardoublepage


\chapter{Discussion}
\import{Chapters/}{07Discussion}
\cleardoublepage


\chapter{Conclusions}
\import{Chapters/}{08Conclusion}
\cleardoublepage
...
\label{app:data}
\import{Chapters/}{90Allresults}
\cleardoublepage
\chapter{Specialization report}
\label{app:spec}
\includepdf[pages={1-}]{../FordypningsRapport/main.pdf}
